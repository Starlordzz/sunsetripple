...
| `lib/core/transport` | 传输接口、LanTransport (TCP/UDP)、BleL2capTransport (BLE L2CAP)、LanRoomDiscovery (UDP 8990 广播) |
...
| `android/` | Android 宿主、前台保活服务、PlatformAudioPlugin 与 BleL2capPlugin |
