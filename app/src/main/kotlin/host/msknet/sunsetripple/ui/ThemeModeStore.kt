 ...
 * 不值得为它多背一个依赖。
 */
class ThemeModeStore(context: Context) : ThemeModePersistence {

    private val preferences = context.applicationContext
        .getSharedPreferences(PREFERENCES_NAME, Context.MODE_PRIVATE)

    override fun load(): ThemeMode = ThemeModeResolver.fromStoredValue(preferences.getString(KEY_MODE, null))
